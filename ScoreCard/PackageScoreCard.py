...
class PackageScoreCard:
    ...
    def toString(self):
        ...
        score_string = str(self.url).rstrip() + " " + str(round(self.total_score, 1)) + " " + str(
            round(self.ramp_up_score, 1)) + " " + \
                       str(round(self.correctness_score, 1)) + " " + str(round(self.bus_factor_score, 1)) + " " + \
                       str(round(self.responsiveness_score, 1)) + " " + str(round(self.license_compatibility_score, 1))
        return score_string
