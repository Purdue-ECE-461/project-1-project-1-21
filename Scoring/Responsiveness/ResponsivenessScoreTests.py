...
class MockResponsivenessPackage:
    ...
    def __init__(self, stargazers_count, open_issues_count, forks_count, watchers_count, network_count):
...
class ResponsivenessScoreTests(unittest.TestCase):
    ...
    def test_0_responsiveness(self):
        mock = MockResponsivenessPackage(stargazers_count=0,
    ...
    def test_0_25_responsiveness(self):
        mock = MockResponsivenessPackage(stargazers_count=100,
    ...
    def test_0_5_responsiveness(self):
        mock = MockResponsivenessPackage(stargazers_count=200,
    ...
    def test_0_75_responsiveness(self):
        mock = MockResponsivenessPackage(stargazers_count=1001,
    ...
    def test_1_responsiveness(self):
        mock = MockResponsivenessPackage(stargazers_count=10001,
                                         open_issues_count=0, 
                                         forks_count=10001,
